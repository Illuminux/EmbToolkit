...
__embtk_hostpkg_ldflags		= -L$(embtk_htools)/usr/lib -L/usr/local/opt/gettext/lib $(__embtk_hostpkg_rpath)
__embtk_hostpkg_cppflags	= -I$(embtk_htools)/usr/include -I/usr/local/opt/gettext/include
